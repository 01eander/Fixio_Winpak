...
import { Search, ArrowLeft, Plus, X, Save, Edit, Trash2, Building2 } from 'lucide-react';
...
export default function Departments() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const url = editingItem ? `${API_URL}/departments/${editingItem.id}` : `${API_URL}/departments`;
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-2xl font-bold text-gradient">Departamentos</h2>
                </div>
                <button
