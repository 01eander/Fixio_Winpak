...
import { Search, ArrowLeft, Plus, X, Save, Edit, Trash2, Tags } from 'lucide-react';
...
export default function InventoryCategories() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const url = editingItem ? `${API_URL}/inventory-categories/${editingItem.id}` : `${API_URL}/inventory-categories`;
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const response = await fetch(`${API_URL}/inventory-categories/${id}`, { method: 'DELETE' });
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-2xl font-bold text-gradient">Categorías de Inventario</h2>
                </div>
                <button
